...
/** merge mod_src into dev_dest history. mod_src->dev may be different from dev_dest */
int dt_history_merge_module_into_history(struct dt_develop_t *dev_dest, struct dt_iop_module_t *mod_src,
                                         GList **_modules_used, const int append);
