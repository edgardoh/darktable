...
static void _retouch_cairo_paint_auto_levels(cairo_t *cr, const gint x, const gint y, const gint w, const gint h, const gint flags)
{
  PREAMBLE;
...
void gui_init(dt_iop_module_t *self)
{
  ...
  g->bt_blur = dtgtk_togglebutton_new(_retouch_cairo_paint_tool_blur, CPF_STYLE_FLAT | CPF_DO_NOT_USE_BORDER);
  ...
  g->bt_auto_levels = dtgtk_togglebutton_new(_retouch_cairo_paint_auto_levels, CPF_STYLE_FLAT | CPF_DO_NOT_USE_BORDER);
