...
/*
  ...
  -ifft[-2,-1] -rm.
*/
if(1)  recontruct_laplacian(img_l, img_grn, img_l, iwidth, iheight, x_from, x_to, y_from, y_to, beta, image_scale);
...
if(1)  adjust_brcogm2(img_dest, width, height, ch, brightness, contrast, gamma);
